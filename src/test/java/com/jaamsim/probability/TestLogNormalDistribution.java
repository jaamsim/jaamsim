...
public class TestLogNormalDistribution {
	...
	public void setupTests() {
		simModel = new JaamSimModel("TestLogNormalDistribution");
	...
	public void MeanAndStandardDeviation() {
		...
		LogNormalDistribution dist = InputAgent.defineEntityWithUniqueName(simModel, LogNormalDistribution.class, null, "Dist", "-", true);
		...
		assertTrue( Math.abs( dist.getSampleStandardDeviation(0.0) / dist.getStandardDeviation(0.0) - 1.0 ) < 0.03 );
	}
}
