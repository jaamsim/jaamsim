...
public class ExpressionLogger extends Logger implements StateEntityListener, ObserverEntity {
	...
	public void startUp() {
		...
		if (!interval.isDefault())
			EventManager.scheduleSeconds(getStartTime(EventManager.simSeconds()), PRI_NORMAL, EVT_LIFO, endActionTarget, null);
	}
	...
	private void startAction() {
		...
		EventManager.scheduleSeconds(dur, PRI_NORMAL, EVT_LIFO, endActionTarget, null);
	}
