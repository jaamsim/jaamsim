...
public class Queue extends LinkedComponent {
	...
	public void addEntity(DisplayEntity ent) {
		...
		if (!userUpdateHandle.isScheduled())
			EventManager.scheduleTicks(0, PRI_HIGH, EVT_LIFO, userUpdate, userUpdateHandle);
		...
		if (!renegeTime.isDefault()) {
			...
			EventManager.scheduleSeconds(dur, PRI_NORMAL, EVT_FIFO, new RenegeActionTarget(this, entry), rh);
		}
	}
