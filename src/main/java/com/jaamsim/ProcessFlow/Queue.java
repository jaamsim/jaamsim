...
public class Queue extends LinkedComponent {
	...
	public void addEntity(DisplayEntity ent) {
		...
		if (!userUpdateHandle.isScheduled())
			EventManager.scheduleTicks(0, PRI_HIGH, false, userUpdate, userUpdateHandle);
		...
		if (!renegeTime.isDefault()) {
			...
			EventManager.scheduleSeconds(dur, PRI_NORMAL, true, new RenegeActionTarget(this, entry), rh);
		}
	}
