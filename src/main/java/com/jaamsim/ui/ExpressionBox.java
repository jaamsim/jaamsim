...
public class ExpressionBox extends JDialog {
	...
	private void tryParse() {
		...
		// Load the input
		try {
			KeywordIndex kw = KeywordIndex.formatInput(input.getKeyword(), str);
	...
	static {
		...
		functions.add(new ButtonDesc("continuous", "User-defined continuous distribution function ('continuous')",
				...
				"Accepts input parameters of cumProbs, values, and random stream. "
						...
						+ "The cumProbs argument is an array of cumulative probabilities with entries that increase monotonically from exactly 0.0 to exactly 1.0. "
		...
		functions.add(new ButtonDesc("discrete", "User-defined discrete distribution function ('discrete')",
				...
				"Accepts input parameters of probs, values, and random stream. "
						...
						+ "The probs argument is an array of probabilities that sum to exactly 1.0. "
