...
public class DynamicDoubleInput extends Input<SampleProvider> {
	private Class<? extends Unit> unitType;

	public DynamicDoubleInput(String key, String cat, SampleProvider def) {
		super(key, cat, def);
	...
	throws InputErrorException {
		...
		value = new OutputSample(ent, output);
	}
}
