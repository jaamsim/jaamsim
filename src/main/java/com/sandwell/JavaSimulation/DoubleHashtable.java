...
public class DoubleHashtable {
	...
	/**
	 *  Constructs a new DoubleHashtable with the same mappings as the given DoubleHashtable
	 */
	public DoubleHashtable( DoubleHashtable t ) {
		hashtable = new Hashtable<Object, Double>( t.hashtable );
	}
